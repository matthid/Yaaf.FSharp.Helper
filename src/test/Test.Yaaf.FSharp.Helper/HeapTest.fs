module Yaaf.FSharp.Collections.Tests.HeapTest

open FSharpx
open Yaaf.FSharp.Collections
open Yaaf.FSharp.Collections.Heap
open Yaaf.FSharp.Collections.Tests.Properties
...
//System.Exception : Geneflect: type not handled Yaaf.FSharp.Collections.Heap`1[System.IComparable]
//[<Test>]
//let ``monoid law``() =
//    registerGen.Force()
